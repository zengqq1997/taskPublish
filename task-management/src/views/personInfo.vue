    ...
    <el-dialog title="个人信息"
      ...
      <el-form>
        <el-form-item label="账号"
          ...
          <el-input v-model="personData[0].value"
                    autocomplete="off"
        ...
        <el-form-item label="用户名"
                      style="padding-left:2em">
          <el-input v-model="personData[1].value"
                    autocomplete="off"
                    style="width: 31em;margin-left: -6em"></el-input>
        </el-form-item>
        <el-form-item label="性别"
                      style="padding-left: 2em;">
          <el-input v-model="personData[2].value"
                    autocomplete="off"
                    style="width: 31em;margin-left: -5em"></el-input>
        </el-form-item>
        <el-form-item label="手机号"
                      style="padding-left: 2em;">
          <el-input v-model="personData[3].value"
                    autocomplete="off"
                    style="width: 31em;margin-left: -6em"></el-input>
        </el-form-item>
        <el-form-item>
          ...
          <el-button @click="resetForm('personInfo')"
...
export default {
  ...
  methods: {
    ...
    submitInfo (formName) {
      this.user.username = this.personData[1].value;
      this.user.gender = this.personData[2].value;
      this.user.tel = this.personData[3].value;
